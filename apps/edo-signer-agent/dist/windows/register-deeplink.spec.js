...
const register_deeplink_1 = require("./register-deeplink");
describe('ensureVrplikeSignerDeeplinkRegisteredWindows', () => {
    test('does nothing on non-windows platform', async () => {
        const calls = [];
        await (0, register_deeplink_1.ensureVrplikeSignerDeeplinkRegisteredWindows)({
            platform: 'linux',
            runReg: async (args) => {
                calls.push(args);
...
//# sourceMappingURL=register-deeplink.spec.js.map